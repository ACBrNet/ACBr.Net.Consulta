...
namespace ACBr.Net.Consulta.Demo
{
	partial class FrmMain
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox7.Controls.Add(this.ufComboBox);
            ...
            "SP",
            "TO"});
			this.ufComboBox.Location = new System.Drawing.Point(6, 35);
			this.ufComboBox.Name = "ufComboBox";
			this.ufComboBox.Size = new System.Drawing.Size(60, 21);
			this.ufComboBox.TabIndex = 22;
			// 
			...
			// acbrIbge
			// 
			this.acbrIbge.OnBuscaEfetuada += new System.EventHandler<System.EventArgs>(this.acbrIbge_OnOnBuscaEfetuada);
			// 
			// acbrCEP
			// 
